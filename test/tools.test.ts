...
const SPENDING_TOOLS = ["cash_flow", "spending_breakdown", "spending_trend", "search_transactions", "budget_vs_actual", "list_scheduled"];
...
const ORDERING: Record<string, RegExp> = {
  ...
  cash_flow: /Months come in chronological order/,
